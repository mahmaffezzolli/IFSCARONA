...
public class CadastroUsuario extends JFrame {
	...
	public CadastroUsuario() throws ParseException {
		...
		CheckConfirmacao.setBounds(1475, 455, 127, 14);
		...
		txtConfirmacaoSenha.setBounds(1266, 402, 336, 46);
		...
		txtSobrenome.setBounds(745, 322, 336, 45);
		...
		lblLinkAqui.setBounds(1372, 455, 178, 14);
		...
		lblPossuiCadastro.setBounds(1266, 455, 178, 14);
		...
		lblIconeConfiormacaoSenha.setBounds(1197, 398, 59, 55);
		...
		lblIconeSenha.setBounds(1192, 317, 59, 55);
		...
		lblIconeDataNascimento.setBounds(1192, 232, 59, 60);
		...
		lblIconeEmail.setBounds(676, 483, 59, 52);
		...
		lblIconeSobrenome.setBounds(676, 322, 59, 45);
		...
		btnCadastrar.setBounds(1345, 487, 178, 54);
		...
		txtCPF.setBounds(745, 403, 336, 45);
		contentPane.add(txtCPF);
		
		lblCPF = new JLabel("CPF:");
		lblCPF.setFont(new Font("Arial", Font.PLAIN, 13));
		lblCPF.setBounds(745, 378, 122, 14);
		...
		txtfundoVerde.setBounds(146, 0, 1939, 1075);
